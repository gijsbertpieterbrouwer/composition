...
import { Collection, CollectionObject, CollectionObjectTypeEnum, CollectionsData, CreateCollectionRequest, DeleteCollectionRequest, DeleteConfirmationInfo, MoveCollectionRequest, MoveObjectToCollectionRequest, ObjectRemovalProgress, UpdateCollectionRequest } from "@/TickApi";
...
function flattenCollection(root: CollectionsData): CollectionObject[] {
  let r: CollectionObject[] = root?.objectsOutsideCollection || [];
  if (root?.collections?.length) {
