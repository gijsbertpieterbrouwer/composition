...
import { TaskFilterOptions, LanguagePath } from "@/TickApi";
import TaskListOptionsEditor from "./TaskListOptionsEditor.vue";
...
export default class TaskListOptionsButton extends Vue {
  Appearance = Appearance
  Color = Color
  Size = Size
  LanguagePath = LanguagePath
  //@Prop({ required: true }) private data!: QuestFilterOptions;
  ...
  private openPanel() {
    ...
    const panelOptions: TickPanelOptions = {
      title: "TaskListOptionsEditor",
      from: getRefElementDOMRect(this, "toggleButton")
    }

    this.activePanel = mount(TaskListOptionsEditor, {
      props: {
