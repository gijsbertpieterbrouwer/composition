...
import CommunicatorListOptionsEditor from "./CommunicatorListOptionsEditor.vue";
...
export default class CommunicatorListOptionsButton extends Vue {
  ...
  private openPanel() {
    ...
    const panelOptions: TickPanelOptions = {
      title: "CommunicatorListOptionsEditor",
      from: getRefElementDOMRect(this, "toggleButton")
    }

    this.activePanel = mount(CommunicatorListOptionsEditor, {
      props: {
