...
import { createVoiceCall, declineVoiceCall, getVoiceCallInfo, holdVoiceCall, linkVoiceCallToTicket, transferVoiceCall } from '@/services/voiceService';
...
export default class TickVoiceCenter extends Vue {
  ...
  private toggleCallOnHold() {
    ...
    holdVoiceCall(useVoiceStore().activeCallId, !this.activePhoneCallOnHold).then(() => {
