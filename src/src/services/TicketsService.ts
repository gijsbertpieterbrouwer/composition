...
import { AddMessageRequest, AddMessageResponse, AddNoteRequest, EditTicketRequest, TicketDetails, GetTicketsRequest, GetTicketsResponse, SetIsTypingRequest, SetTicketAssignmentsRequest, SetTicketLabelsRequest, TimelineDataItem, AddTicketRequest, AddTicketResponse, AddExternalMessageRequest, AddExternalMessageResponse } from "@/TickApi";
...
export async function getTickets(workspaceId: string, req: GetTicketsRequest): Promise<GetTicketsResponse> {
