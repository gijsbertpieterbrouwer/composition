...
const useAppStore = defineStore<"app", State, Getters, Actions>("app", {
  ...
  getters: {
    ...
    highestDialog() {
      return this.dialogStack.length ? this.dialogStack.at(-1) : null;
    },
  ...
  actions: {
    ...
    logOut() {
      ...
      const settings: UserSettings = {
        ...
        tickets: {
          filterOptions: useTicketsStore().ticketFilters,
          listOptions: useTicketsStore().listOptions,
        },
        voice: {
          autoConnect: useVoiceStore().autoConnect,
          defaultChannelId: useVoiceStore().defaultChannelId,
        }
      };
