...
export function generateBorderRadius(value: number | ChatWidgetStylingSettingsData, factor?: number): string {
  ...
  if (!valIsNumeric && (stylingData && (stylingData.borderRadius_Linked || stylingData.borderRadius_LeftTop == null))) {
    valIsNumeric = true;
    value = stylingData.borderRadius;
  }
  ...
  if (!value || valIsNumeric) {
    ...
    return stylingData.borderRadius_Linked
      ? generateBorderRadius(stylingData.borderRadius)
      : `${generateBorderRadius(stylingData?.borderRadius_LeftTop)} ${generateBorderRadius(stylingData?.borderRadius_RightTop)} ${generateBorderRadius(stylingData?.borderRadius_RightBottom)} ${generateBorderRadius(stylingData?.borderRadius_LeftBottom)}`
  }
}
