...
export function getCostItemTypeName(type: SubscriptionCostItemType | undefined): string {
...
export function getColorOptions() {
  ...
  const list = colors.map((c) => ({
    text: c,
    value: ColorsEnum[c as keyof typeof ColorsEnum],
  }));
...
export enum TickButtonSize {
  mini = "mini",
  regular = "regular",
  XXL = "xxl",
}

export enum TickButtonAppearance {
  primary = "primary",
  secondary = "secondary",
  transparent = "transparent",
}

export enum TickButtonColor {
  primary = "primary",
  secondary = "secondary",
  tertiary = "tertiary",
  contrast = "contrast",
