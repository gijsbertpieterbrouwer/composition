...
import { AssignmentFilterEnum, LanguagePath, TaskFilterOptions, TaskFilterTaskStatusEnum } from "@/TickApi";
...
import { getTaskStatusOptions } from "@/helpers/enumsHelper";
...
export default class TaskFiltersEditor extends Vue {
  ...
  @Prop() private data!: TaskFilterOptions;

  private editingModel: TaskFilterOptions = {};
