...
export async function getTenantInfo(request: GetTenantInfoByUrlNameRequest): Promise<GetTenantInfoServiceResponse | null> {
...
export async function preRegister(request: PreRegisterRequest): Promise<PreRegisterResponse | null> {
...
export async function getRegisterProgress(request: GetRegisterProgressRequest): Promise<GetRegisterProgressResponse | null> {
