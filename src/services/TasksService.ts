...
export async function getTasks(workspaceId: string, req: GetTasksRequest): Promise<GetTasksResponse | null> {
...
export async function addTask(data: TickCreateTaskInstanceRequest): Promise<TickTaskInstanceSummary | undefined> {
  try {
...
export async function updateTask(id: string | undefined, data: TickTaskWorkingData) {
  if (!id) { return; }
  try {
